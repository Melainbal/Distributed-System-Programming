...
public class Step2BigramsAggregation {
    ...
    public static class Step2BigramsAggregationMapper extends Mapper<LongWritable, Text, Text, Text> {
        ...
        // input - <w#i decade , <w1 w2 decade>>,
        //  <w#i decade, occur> , <w1 w2 decade, occur>
    ...
    public static class Step2BigramsAggregationReducer extends Reducer<Text, Text, Text, Text> {
        ...
        public void reduce(Text key, Iterable<Text> values, Context context) throws IOException, InterruptedException {
            ...
            if (keyParts.length > 2) {
                ...
                // Process unigram keys (w#i decade)
                String word_key = keyParts[0];
                String[] word_parts = word_key.split("#");
                String word = word_parts[0];
                String positionIndicator = word_parts[1];
    ...
    public static void main(String[] args) throws Exception {
        ...
        FileInputFormat.addInputPath(job, new Path("s3://n-gram-analysis/output_step_1_heb"));
        FileOutputFormat.setOutputPath(job, new Path("s3://n-gram-analysis/output_step_2_heb"));
