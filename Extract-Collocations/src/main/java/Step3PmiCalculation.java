...
public class Step3PmiCalculation {
    ...
    public static void main(String[] args) throws Exception {
        ...
        FileInputFormat.addInputPath(job, new Path("s3://n-gram-analysis/output_step_2_heb"));
        FileOutputFormat.setOutputPath(job, new Path("s3://n-gram-analysis/output_step_3_heb"));
